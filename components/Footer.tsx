...
export default function Footer() {
    ...
    return (
        <>
            <div className="w-full btm-bg-gray-700 text-white px-4 py-16 mt-20 text-center leading-8" style={{backgroundImage: 'url("/bg-dim-50.png")'}}>
                <div className="mx-auto max-w-5xl">
                    ...
                    <p>
                        Built with ♥ in Toronto by <a href="https://lauragao.ca" className="underline transition theme-hover">Laura Gao</a>
                    </p>
                    <p>
                        The Chive © 2021.
                    </p>
