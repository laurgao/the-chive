...
I used to struggle a lot with getting things done on a day-to-day basis. What I found has helped me the most with my life and most of my recent successes, is when I focus on this moment, putting in the best work today. As my friend Samson describes, "relentlessly pursue what feels right in the moment, and continuously reassess." Impact Theory host Tom Bilyeu said, "I'd rather be sprinting 1000 miles in the wrong direction than not moving at all."

In the past few months, this is the strategy I adopted for my own productivity - going ham on the nearest, most appealing path. Just like machines learn by assessing their surroundings in the cost function vectorspace relentlessly going down the path of steepest descent through a process called gradient descent. AI doesn't know where it will end up, a dog-generating model doesn't know what a dog looks like when it starts training, but by relentlessly pursuing what feels right in the moment, the AI reaches an adequate minimum despite its uneventful start. For this reason, I like to call this approach "playing gradient descent with my life."

Of course, this model isn't perfect - if we take the analogy further, only exploiting in your pursuits gets you stuck in a local minimum. That's where the value of exploration comes in. However that's a different topic and I digress

Relentlessly pursue and optimize for the small things in success. And do the same with activism. The world is not moved in big leaps but in baby steps. Focusing on the second world on a day to day basis more often than thinking about the dream to change the world propels you closer towards reality, and by extension, helps you be more successful in your projects, feminism, and anything you do.
